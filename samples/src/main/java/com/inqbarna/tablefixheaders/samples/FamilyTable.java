...
public class FamilyTable extends AppCompatActivity {
    ...
    public class FamilyNexusAdapter extends BaseTableAdapter {
        ...
        public FamilyNexusAdapter(Context context) {
            ...
            familys[2].list.add(new Nexus("Nexus One", "HTC", "Gingerbread", "10", "512 MB", "3.7\"", "512 MB"));
            familys[1].list.add(new Nexus("Nexus S", "Samsung", "Gingerbread", "10", "16 GB", "4\"", "512 MB"));
            familys[1].list.add(new Nexus("Galaxy Nexus (16 GB)", "Samsung", "Ice cream Sandwich", "15", "16 GB", "4.65\"", "1 GB"));
            familys[1].list.add(new Nexus("Galaxy Nexus (32 GB)", "Samsung", "Ice cream Sandwich", "15", "32 GB", "4.65\"", "1 GB"));
            familys[1].list.add(new Nexus("Nexus 4 (8 GB)", "LG", "Jelly Bean", "17", "8 GB", "4.7\"", "2 GB"));
            familys[1].list.add(new Nexus("Nexus 4 (16 GB)", "LG", "Jelly Bean", "17", "16 GB", "4.7\"", "2 GB"));
            familys[1].list.add(new Nexus("Nexus 7 (16 GB)", "Asus", "Jelly Bean", "16", "16 GB", "7\"", "1 GB"));
            familys[1].list.add(new Nexus("Nexus 7 (32 GB)", "Asus", "Jelly Bean", "16", "32 GB", "7\"", "1 GB"));
            familys[1].list.add(new Nexus("Nexus 10 (16 GB)", "Samsung", "Jelly Bean", "17", "16 GB", "10\"", "2 GB"));
            familys[1].list.add(new Nexus("Nexus 10 (32 GB)", "Samsung", "Jelly Bean", "17", "32 GB", "10\"", "2 GB"));
            familys[1].list.add(new Nexus("Nexus Q", "--", "Honeycomb", "13", "--", "--", "--"));
        }
        ...
        /**
         * This represents a view in the first column of the table. This is usually fixed
         *
         * @param row         the row we are displaying
         * @param column      the column we are displaying
         * @param convertView the view we are recycling
         * @param parent      parent view this view belonngs to
        ...
        private View getFirstBody(int row, int column, View convertView, ViewGroup parent) {
            ...
            convertView.setBackgroundResource(row % 2 == 0 ? R.color.white : R.color.f_grey);
            ((TextView) convertView.findViewById(android.R.id.text1)).setText(getDevice(row).data[column + 1]);
            ((TextView) convertView.findViewById(android.R.id.text2)).setText((String.format("%d", row)));
            return convertView;
        }
    ...
    private String padWithSpaces(String f) {
        for (int i = f.length(); i < 4; i = i + 1) {
            f = " " + f;
        }
        return f;
    }
